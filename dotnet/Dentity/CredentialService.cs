...
using Dentity.Services.VerifiableCredentials.V1;

namespace Dentity;

public class CredentialService : ServiceBase
{
    public CredentialService(DentityOptions options)
        : base(options) {
        Client = new(Channel);
    }
...
// target: /home/runner/work/sdk/sdk/dotnet/Dentity/CredentialService.cs
