...
{
    public FileManagementService(DentityOptions options)
        : base(options) {
        Client = new(Channel);
    }
...
// target: /home/runner/work/sdk/sdk/dotnet/Dentity/FileManagementService.cs

	/// <summary>
    ///This method is experimental
    ///  Upload a file to Dentity's CDN
    /// </summary>
